...
export const getNewHoaxCountOfUser = (username, id) => {
  return axios.get(`/api/1.0/users/${username}/hoaxes/${id}?count=true`);
};
...
export const getNewHoaxesOfUser = (username, id) => {
  return axios.get(`/api/1.0/users/${username}/hoaxes/${id}?direction=after`);
};
